...
export function HeroSection() {
  return (
    <section id="hero" className="flex min-h-screen w-full flex-col md:flex-row" aria-labelledby="hero-title">
      <div className="flex w-full flex-col justify-center bg-[var(--bg)] px-8 pb-16 pt-24 md:w-1/2 md:pl-20 md:pr-12 md:pb-0 md:pt-24 lg:pt-0">
        <p
          id="hero-title"
          className="mb-4 font-[var(--font-dm-sans)] text-[2.2rem] font-bold text-[var(--text)] md:text-[2.4rem] lg:text-[2.8rem]"
        >
          Hi, I'm Falak Naaz Fatma
        </p>
        <p className="mb-4 font-[var(--font-dm-sans)] text-[2.2rem] font-bold text-[var(--text)] md:text-[2.4rem] lg:text-[2.8rem]">
          I <TypewriterText />
        </p>
        ...
        <div className="flex lg:hidden items-center gap-6 mt-8">
          <a
            ...
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-text transition-opacity duration-200 hover:opacity-80"
          >
